  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    if (e.key === 'Tab') {
      ...
      if (!prompt.trim()) {
        ...
        // Insert the placeholder text as value when Tab is pressed on empty textarea
        const placeholderText = "Example: Kangaroo carrying a corgi in cartoon style";
          ...
          <div className="prompt-label-container">
            ...
            <div className="info-icon-container">
              <button 
                ...
                title="Write a detailed description of what you want to generate"
                tabIndex={8}
              >
              ...
              {showInfoTooltip && (
                <div className="info-tooltip">
                  ...
                  e.g., an object in a location in color
                </div>
              )}
            </div>
          </div>
