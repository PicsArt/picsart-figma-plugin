...
import {
  ...
  SIGN_IN_BTN_TEXT,
  SIGN_IN_RETRY_BTN_TEXT,
  SIGN_OUT_BTN_TEXT,
  CANCEL_BTN_TEXT,
  USE_API_KEY_BTN_TEXT,
  REOPEN_BROWSER_BTN_TEXT,
...
const btnTypes: Record<BtnType, string> = {
  ...
  [BtnType.CONTINUE_DISABLED]: CONTINUE_BTN_TEXT,
  ...
  [BtnType.REMOVE_KEY]: REMOVE_KEY_BTN_TEXT,
  [BtnType.SIGN_IN]: SIGN_IN_BTN_TEXT,
  [BtnType.SIGN_IN_DISABLED]: SIGN_IN_BTN_TEXT,
  [BtnType.SIGN_IN_RETRY]: SIGN_IN_RETRY_BTN_TEXT,
  [BtnType.SIGN_OUT]: SIGN_OUT_BTN_TEXT,
  [BtnType.CANCEL]: CANCEL_BTN_TEXT,
  [BtnType.USE_API_KEY]: USE_API_KEY_BTN_TEXT,
  [BtnType.REOPEN_BROWSER]: REOPEN_BROWSER_BTN_TEXT,
};
...
const DISABLED_TYPES: BtnType[] = [
  ...
  BtnType.CONTINUE_DISABLED,
  BtnType.SIGN_IN_DISABLED,
];
